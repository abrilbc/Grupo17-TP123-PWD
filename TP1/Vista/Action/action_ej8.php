...
<body>
    ...
    <div class="container">
        ...
        <form action="./Action/action_ej8.php" method="post" id="miFormulario">
            ...
            <input type="number" id="edad" name="edad" value="<?php echo $edad; ?>" disabled><br>
            <label for="estudiante">¿Es estudiante?</label><input type="text" disabled value="<?php echo $estudiante; ?>">
