...
<head>
    ...
    <script src="<?php echo $baseURL . "/TP2/EJ3/Vista/js/validaciones.js"; ?>"></script>
            ...
            <div class="col-3">
                <nav>
                    <ul class="nav justify-content-around list-unstyled">
                        ...
                        <li class="nav-item"><a href="<?php echo $baseURL; ?>/TP2" class="nav-link current-nav-link">TP 2</a></li>
