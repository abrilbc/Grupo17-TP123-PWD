...
$respuesta = $objPelicula-> subirArchivo();
            ...
            <div class="text-success fs-5 ">
                ...
                <?php 
                     if ($respuesta !== "" && file_exists($respuesta)) {
                        echo "<img src='$respuesta' alt='Portada' class='position-absolute w-25 end-0 top-0 mt-5 me-5' >";
                    } else {
                        echo nl2br("$respuesta");
                    }
                ?>
            </div>
            <a href="../Ejercicio3.php" class="text-decoration-none text-reset fw-semibold"><div class="position-absolute top-0 end-0 m-3 p-1 pe-2 ps-2 btn btn-info">X</div></a>
        </div>
    </div>
</body>
</html>