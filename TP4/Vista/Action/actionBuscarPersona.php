                ...
                $rpta = <<<HTML
                    ...
                    <form onsubmit="return validar()" action="ActualizarDatosPersona.php" class="d-flex flex-column align-items-center gap-3 w-75" method="POST">
                        ...
                        <div class="form-group w-100 text-center">
                            ...
                            <input class="form-control p-2 mb-3 fs-6 bg-white mx-auto w-75" type="text" id="Nombre" name="Nombre" placeholder="Nombre" value="{$verificacionPersona->getNombre()}">
                            <span class="text-danger" id="actNombre"></span>
                        </div>
                        <div class="form-group w-100 text-center">
                            <label for="apellido" class="fs-5 fw-bold">Apellido</label>
                            <input class="form-control p-2 mb-3 fs-6 bg-white mx-auto w-75" type="text" id="Apellido" name="Apellido" placeholder="Apellido" value="{$verificacionPersona->getApellido()}">
                            <span class="text-danger" id="actApellido"></span>
                        </div>
                        <div class="form-group w-100 text-center">
                            <label for="fechaNac" class="fs-5 fw-bold">Fecha Nacimiento</label>
                            <input class="form-control p-2 mb-3 fs-6 bg-white mx-auto w-75" type="text" id="fechaNac" name="fechaNac" placeholder="Fecha Nacimiento" value="{$fechaFormateada}">
                            <span class="text-danger" id="actFecha"></span>
                        </div>
                        <div class="form-group w-100 text-center">
                            <label for="telefono" class="fs-5 fw-bold">Teléfono</label>
                            <input class="form-control p-2 mb-3 fs-6 bg-white mx-auto w-75" type="text" id="Telefono" name="Telefono" placeholder="Teléfono" value="{$verificacionPersona->getTel()}">
                            <span class="text-danger" id="actTel"></span>
                        </div>
                        <div class="form-group w-100 text-center">
                            <label for="domicilio" class="fs-5 fw-bold">Domicilio</label>
                            <input class="form-control p-2 mb-3 fs-6 bg-white mx-auto w-75" type="text" id="Domicilio" name="Domicilio" placeholder="Domicilio" value="{$verificacionPersona->getDomicilio()}">
                            <span class="text-danger" id="actDom"></span>
                        </div>
                        <div class="d-flex flex-column align-items-center gap-3 w-100">
                            <button class="btn btn-success fs-5 w-50" type="submit">Actualizar</button>
